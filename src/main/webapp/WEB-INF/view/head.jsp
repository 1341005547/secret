...
<!-- Morris chart -->
<link rel="stylesheet"
	href="<%=path%>/static/bower_components/morris.js/morris.css">
<!-- jvectormap -->
<link rel="stylesheet"
	href="<%=path%>/static/bower_components/jvectormap/jquery-jvectormap.css">
<!-- Date Picker -->
<link rel="stylesheet"
	href="<%=path%>/static/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
<!-- Daterange picker -->
<link rel="stylesheet"
	href="<%=path%>/static/bower_components/bootstrap-daterangepicker/daterangepicker.css">
<!-- bootstrap wysihtml5 - text editor -->
<link rel="stylesheet"
	href="<%=path%>/static/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
<!-- 管理模块样式 -->
<link rel="stylesheet"
	href="<%=path%>/static/bower_components/manage/css/manage.css">
<!-- Google Font -->
<link rel="stylesheet"
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		</a> <!-- Header Navbar: style can be found in header.less  判断邮件提醒--> <nav
								...
								<ul class="menu">
									<li>
										<!-- start message --> <a href="#">
											<div class="pull-left">
												<img src="<%=path%>static/dist/img/user2-160x160.jpg"
						...
						<ul class="dropdown-menu">
							...
							<li>
								...
								<ul class="menu">
									...
									<li>
										<p align="center">
											<strong>状态</strong>： <span id="spanqq"> <c:if
													test="${outmasi==null}">[未签到] [未签退]</c:if> <c:if
													test="${outmasi.omsState==1}">[已签到] [未签退]</c:if> <c:if
									...
									<li>
										<div id="newsletter" align="center">
											<input type="submit" value="签到" title="我要签到"
												...
												style="border-right: #FFF solid 2px"
												onclick="return inreg()" /> <input type="submit" value="签退"
												title="我要签退" class="subscribebtn"
												style="border-right: #FFF solid 2px;"
							...
							<div class="pull-right">
								<c:if test="${!empty usercode}">
									<a class="btn btn-default btn-flat" data-toggle="modal"
										data-target="#myModal_password">修改密码</a>
...
<<<<<<< HEAD
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-laptop"></i>
					<span>人事管理</span> <span class="pull-right-container"> <i
				...
				<ul class="treeview-menu">
					...
					<li><a href="index2.html"><i class="fa fa-circle-o"></i>
							员工管理</a></li>
					<li><a href="index3.html"><i class="fa fa-circle-o"></i>
							调动管理</a></li>
					<li><a href="index2.html"><i class="fa fa-circle-o"></i>
							通讯录管理</a></li>
				</ul></li>
			<li class="treeview"><a href="#"> <i class="fa fa-files-o"></i>
					<span>日程管理</span> <span class="pull-right-container"> <span
			...
			<li class="treeview"><a href="#"> <i class="fa fa-pie-chart"></i>
				...
				<ul class="treeview-menu">
					...
					<!--  -->
					<shiro:hasPermission name="申请管理页面权限">
						<li><a href="applymanage"><i class="fa fa-circle-o"></i>申请管理</a></li>
					</shiro:hasPermission>


					<li><a href="reimburseapplymanage"><i
							class="fa fa-circle-o"></i>报销管理</a></li>
				</ul></li>
			<!--  -->
			<!-- 考勤管理 -->
=======
...
<<<<<<< HEAD
			...
			<li class="treeview"><a href="#"> <i class="fa fa-laptop"></i>
				...
				<ul class="treeview-menu">
					<li><a href="toemail.html"><i class="fa fa-circle-o"></i>
							邮箱</a></li>
				</ul></li>
			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>授权管理</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="power_look.html"><i class="fa fa-circle-o"></i>
							我的权限</a></li>
					<li><a href="power_set.html"><i class="fa fa-circle-o"></i>
							角色设定</a></li>
					<li><a href="power_give.html"><i class="fa fa-circle-o"></i>
							权限分配</a></li>
				</ul></li>
			<!-- 系统管理 -->
						...
						<form class="form-login" action="tologin" method="post">
							<div class="login-wrap">
								<input type="text" class="form-control" placeholder="工号"
									name="loginUsercode"> <br> <input type="password"
									class="form-control" placeholder="密码" name="loginPassword">
				...
				<div class="modal-content">
					...
					<div class="box-footer">
						...
						<c:forEach items="${roles}" var="r">${r.rName },</c:forEach>
							...
							<li><a href="#">入职时间：<fmt:formatDate
										value="${user.uStartTime}" /></a></li>
