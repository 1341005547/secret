...
<link
	href="https://cdn.bootcss.com/bootstrap/4.0.0-beta.3/css/bootstrap-grid.css"
	rel="stylesheet">
<link href="<%=path%>/static/css/templatemo_style.css"
							...
							<div class="panel-group" id="panel-614238">
								<div class="panel panel-default">
									...
									<div id="panel-element-288445" class="panel-collapse in">
										<div class="panel-body">授权管理模块-权限查看-该页面查看用户的权限角色</div>
									</div>
								</div>
								<div class="panel panel-default">
									<div class="panel-heading">
							...
							<div class="accordion" id="accordion-354281">
								...
								<div id="contact_form" style="width: 400px;">
									...
									<table width="720">
										...
										<tr>
											<td height="40">隶属上级领导：</td>
											<td><c:out value="${create_Name }"></c:out></td>
										</tr>
										<tr>
											<td height="40">授权时间：</td>
											<td><fmt:formatDate pattern="yyyy-MM-dd"
													value="${givePowerTime}" type="time" /></td>
										</tr>
										<tr>
