  ...
  <div class="register-box-body">
    ...
    <form action="department_add.html" method="post">
      <div class="form-group has-feedback">
        <input name="dId" type="text" class="form-control" placeholder="部门id">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
       <div class="form-group has-feedback">
        <input  type="text" class="form-control" name="dName" placeholder="部门名称">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
     <!-- <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="部门名称">
      ...
      <div class="row">       
        <!-- /.col -->        
      <input type="submit" href="department.html" class="btn btn-block btn-facebook btn-flat">
