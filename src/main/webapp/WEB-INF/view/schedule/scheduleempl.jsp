...
<body class="hold-transition skin-blue sidebar-mini">
					...
					<div class="box-body">
						...
						<form name="create_calender" id="create_calender" action=""
							...
							日程内容：<input type="text" style="height: 30px; width: 70%"
								name="scheduleContent" /><br> <br> 时间范围：<input
								type="text" style="height: 30px; width: 70%" name="DateFrame"
								id="DateFrame" /><br> <br>
							...
							<center>
								...
								<button type="submit" class="btn btn-primary btn-sm"
									data-toggle="modal" onclick="return Check('save')" name="save"
									id="save">提交</button><br><br>
							</center>
							<center>
								<a class="btn btn-primary btn-sm"
									href="showscheduleempl">查看日程详情</a>
							</center>
						</form>
					</div>
				</div>
	...
	<script type="text/javascript">
	function Check(name){
		if(create_calender.scheduleContent.value==''){
			alert("日程内容不能为空！");
			return false;
		}
		...
		if(name=='save'){
			if(confirm("是否提交？"))
				document.create_calender.action = "addscheduleempl";
			else
				return false;
		} 
		return true;
