...
<head>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="<%=path %>/static/bower_components/fullcalendar/dist/fullcalendar.min.css">
  <link rel="stylesheet" href="<%=path %>/static/bower_components/fullcalendar/dist/fullcalendar.print.min.css" media="print">
  <!-- Theme style -->
        ...
        <div class="col-md-3">
          <div class="box box-solid">
            ...
            <div class="box-body">
              ...
              <form name="create_calender" action="" method="post">

                日程内容：<input type="text" style="height:30px" name="s_content" /><br><br>

                开始时间：<input type="text" style="height:30px" name="s_start_time" id="DateStart" /><br><br>

                结束时间：<input type="text" style="height:30px" name="s_end_time" id="DateEnd" /><br><br>
...
<script src="<%=path %>/static/bower_components/fullcalendar/dist/fullcalendar.min.js"></script>
