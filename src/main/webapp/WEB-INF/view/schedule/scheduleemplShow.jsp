			...
			<div class="row">
				<div class="col-md-4" style="margin: 13px; width: 450px">
					...
					<div class="box box-widget widget-user-2">
						...
						<form method="post" action="saveEditScheduleempl">
							<center>
					            ...
					            <input id="end" name="scheduleEndTime" /><em style="color:#F00">&nbsp;*</em><br><br>
						        ...
						        <input type="submit" value="提交" onclick="if(confirm('确定提交?')==false)return false;" class="submit_btn float_r" />
					        </center>
				          </form>
						</div>
					</div>
