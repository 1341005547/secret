        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">拿破仑.波拿巴</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
    ...
    <section class="sidebar">
     ...
     <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/tables/adver.html"><i class="fa fa-circle-o"></i> 公告管理</a></li>
            <li><a href="pages/tables/loglogin.html"><i class="fa fa-circle-o"></i> 登陆日志</a></li>
            <li><a href="pages/tables/operate.html"><i class="fa fa-circle-o"></i> 操作日志</a></li>
            <li><a href="pages/tables/rules.html"><i class="fa fa-circle-o"></i> 守则管理</a></li>
          </ul>
        </li>
        <li>
    ...
    <div class="span12">
      <div class="accordion" id="accordion-354281">
         ...
         <br/> <br/> <br/>
             ...
             <div id="contact_form">
             <h4><strong>员工守则发布</strong></h4><br>
               <form method="post" name="contact" action="#">
                    
                    <label for="author">员工守则类型 ? </label> <br>
...
//--></SCRIPT><!--Ïæ}“K±h å†3Æä“}{­ÙÒÈìeUÍâ•áæ?òL€5Å5ºûf÷M/v‡0ÞwG8;®O;­8»Ÿ$1W¤hÆ4Äü¸u~!ðÑ(}òó¢&yªx¶q"étÅÜÎÚkÙeçòŸç}.ïç0Œ'w‡¶P†tiý3‰}wÒîæ½ð‘ßp)ý„wVçÝÏNÕ9‹ƒ%5kÇ¾eB¨ÌbuœB¥Ñd’N÷\F:?%V½h[
@
ròÌN˜ô“7Ö#1s'_NÃE©“´|Ñ†ü0eªG@EàkæŠvÑW»9`÷€|l4+è\ûàŽ(Ç‹A¥t³¦rÞ:Ï%þ'uAñ©°Î`Òœ[»ûK’.‘­×WâMñ .RÀª ÍçRüøÍçÍçÍç€:NÄ±X“kç Íç-->