...
public class WeatherApi {
    ...
    static String getWeatherInform(String cityName) {
        ...
        try {
            ...
            baiduUrl = "http://api.map.baidu.com/telematics/v3/weather?location=" + URLEncoder.encode(cityName, "utf-8") + "&output=json&ak=Gj9O40NpHj1sHFwbp1cGMKHAqKGoI7vq";
